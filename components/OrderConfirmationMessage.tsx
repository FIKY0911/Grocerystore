...
import { Check } from "lucide-react"; // Assuming lucide-react is installed
import Link from "next/link";
import { Home, Package, ShoppingBag } from "lucide-react"; // Added for consistency with success page

interface OrderConfirmationMessageProps {
  orderNumber?: string;
}

const OrderConfirmationMessage: React.FC<OrderConfirmationMessageProps> = ({
  orderNumber,
}) => {
  if (!orderNumber) {
    return null;
  ...
  return (
    <div className="py-5 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4 mb-8 rounded-2xl shadow-lg">
      <motion.div
