...
const SuccessClient: React.FC<SuccessPageClientProps> = ({ order }) => {
  ...
  if (!order) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-lg text-red-500">Pesanan tidak ditemukan.</p>
      </div>
    );
  }
    ...
    <div className="py-5 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4">
      ...
      >
        ...
        <div className="space-y-4 mb-4 text-left">
          ...
          <p className="text-gray-700">
            Order Number:{" "}
            <span className="text-black font-semibold">{order.orderNumber}</span>
          </p>
          <p className="text-gray-700">
            Status Pembayaran:{" "}
